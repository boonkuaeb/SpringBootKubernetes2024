package com.bk.eazybytes.accounts.controller;
...
@Tag(
        name = "REST APIs for Customer Detail in EazyBank",
...
public class CustomerController {
    ...
    public ResponseEntity<CustomerDetailDto> fetchCustomerDetails(@RequestHeader("eazybank-correlation-id") String correlationId,
                                                                  @RequestParam
